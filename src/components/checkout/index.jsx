...
const checkOut = (props) => {
    ...
    const {cart: cartItems} = useSelector(state=>state.cartList);
    const symbol = "TND";
            ...
            var handler = (window).StripeCheckout.configure({
                ...
                token: (token) => {
                    ...
                    props.history.push({
                        ...
                        state: { payment: token, items: props.cartItems, orderTotal: props.total, symbol: props.symbol }
                    })
                }
            });
            handler.open({
    ...
    return (
        <div>
            ...
            {/*SEO Support*/}
            <Helmet>
                <title>Ayen | CheckOut Page</title>
                <meta name="description" content="ayen marketplace." />
            </Helmet>
            {/*SEO Support End */}
